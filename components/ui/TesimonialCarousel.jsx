        ...
        <div className="relative w-screen h-60">
          ...
          <div className="w-full absolute left-0 top-14 flex px-8 flex-col leading-4 text-left pb-4 pt-10 bg-[#f36] ">
            <p className="text-[8px] ">
              ...
              Crombie is the 2.0 version of a changing company, transforming and
              configuring itself each day
            </p>
        ...
        <div className="relative w-screen h-60">
          ...
          <div className="w-full absolute left-0 top-14 flex px-8 flex-col leading-4 text-left pb-4 pt-10 bg-[#f36] ">
            <p className="text-[8px] ">
              ...
              Behind every development is an enthusiastic team focused on doing
              their best and that’s always a fantastic starting point. Hope you
              enjoy the same way as us!
            </p>
            <p className="font-bold text-[8px] mt-2 mb-4">
              Laura Mo - PM Crombie
            </p>
